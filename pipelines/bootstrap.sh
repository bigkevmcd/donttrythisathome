...
oc apply -f $HOME/Downloads/shbose-secret.yml
oc create secret generic regcred --from-file=.dockerconfigjson=$HOME/Downloads/shbose-auth.json --type=kubernetes.io/dockerconfigjson
